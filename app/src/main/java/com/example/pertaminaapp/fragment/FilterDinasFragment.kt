...
class FilterDinasFragment : DialogFragment() {
    ...
    interface FilterDialogListener {
        fun onFilterApplied(selectedStatus: String, selectedKota: String, selectedTahun: String)
    }
...
// Set adapters for the AutoCompleteTextViews
        ...
        buttonApply.setOnClickListener {
            ...
            filterListener?.onFilterApplied(selectedStatus, selectedKota, selectedTahun)
